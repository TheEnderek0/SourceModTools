...
class SMTBase():
    def __init__(self, name:str, verbose:bool, cfg_path:Path, args: dict[str, str] = {}):
        ...
        if "wd" in args.keys(): # Working dir override
            self.wd = Path(args["wd"])
        elif not self.findwd():
